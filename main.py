...
def colors(value):
    patterns = {
        'R1' : '\033[31;1m', 'R2' : '\33[31;1m',
        'G1' : '\033[32;1m', 'Y1' : '\33[0;32m',
        'P1' : '\033[35;1m', 'CC' : '\33[1;33m'
    }
...
def log(value, status='[Y1]isi Psiphon Pro', color='[CC]'):
...
class domain_fronting(threading.Thread):
    ...
    def log(self, value, status='[R1]MENGHUBUNGKAN ==>', color='[CC]'):
    ...
    def run(self):
        try:
            ...
            self.log('SABAR GAN!!! '.format(self.proxy_host, self.proxy_port))
